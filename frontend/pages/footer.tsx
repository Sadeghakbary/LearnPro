...
export default function Footer() {
  ...
  return (
    <Box sx={{ backgroundColor: "primary.main", color: "#fff", mt: 4, py: 4 }}>
      <Container>
        <Grid container spacing={4}>
          ...
          <Grid item xs={6} md={2}>
            ...
            {[
              { label: translate.footer.Connectiondetails.aboutUs, href: "/about" },
              { label: translate.footer.Connectiondetails.connectwithus, href: "/contact" },
              { label: translate.footer.Connectiondetails.Question, href: "/faq" },
            ].map((page, index) => (
              <Typography
                key={index}
                component="a"
